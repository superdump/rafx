...
// pub(crate) fn msl_assign_argument_buffer_ids(resources: &mut Vec<RafxShaderResource>) -> BTreeMap::<ResourceBindingLocation, ResourceBinding> {
...
//         //resource.msl_argument_buffer_id = msl_argument_buffer_id;
//
