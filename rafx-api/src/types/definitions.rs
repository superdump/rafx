...
#[derive(Clone, Debug, Default)]
pub struct RafxShaderStageMetalInfo {
    // most common entry point is "main" and metal explicitly disallows this. spirv_cross renames
    // the entry point to "main0" by default
...
pub struct RafxShaderStageDef {
    ...
    // Only necessary for compute shaders stages
    pub compute_threads_per_group: Option<[u32; 3]>,
    pub metal_info: Option<RafxShaderStageMetalInfo>,
}
